    ...
    while True:
        try:
            ...
            for order in expired:
                try:
                    await bot.send_message(order.user_id, f"⌛ Order #{order.id} expired after its full 10-minute payment window. No inventory was deducted. Please create a new order.")
